# Comparing `tmp/usody_sanitize-0.1.0b1.tar.gz` & `tmp/usody_sanitize-0.1.0b2.tar.gz`
...
+gzip compressed data, was "usody_sanitize-0.1.0b2.tar", max compression
```

## Comparing `usody_sanitize-0.1.0b1.tar` & `usody_sanitize-0.1.0b2.tar`
...
+-rw-r--r--   0        0        0    18092 2023-02-19 02:19:59.304629 usody_sanitize-0.1.0b2/LICENSE
+-rwxr-xr-x   0        0        0     4349 2023-04-19 05:21:38.796418 usody_sanitize-0.1.0b2/README.md
+-rwxr-xr-x   0        0        0      746 2023-04-17 19:57:06.019344 usody_sanitize-0.1.0b2/pyproject.toml
+-rwxr-xr-x   0        0        0       28 2023-04-17 19:57:17.796161 usody_sanitize-0.1.0b2/usody_sanitize/__init__.py
+-rw-r--r--   0        0        0     2310 2023-04-19 05:23:16.030593 usody_sanitize-0.1.0b2/usody_sanitize/cmd_client.py
+-rwxr-xr-x   0        0        0     4785 2023-04-19 05:21:37.169737 usody_sanitize-0.1.0b2/usody_sanitize/commands.py
+-rwxr-xr-x   0        0        0    11326 2023-04-19 05:19:53.628878 usody_sanitize-0.1.0b2/usody_sanitize/erasure.py
+-rwxr-xr-x   0        0        0     1120 2023-04-17 03:46:30.428865 usody_sanitize-0.1.0b2/usody_sanitize/main.py
+-rw-r--r--   0        0        0     2975 2023-04-17 04:17:15.564592 usody_sanitize-0.1.0b2/usody_sanitize/methods.py
+-rw-r--r--   0        0        0      206 2023-02-21 01:32:23.532667 usody_sanitize-0.1.0b2/usody_sanitize/schemas/__init__.py
+-rw-r--r--   0        0        0      716 2023-02-21 01:33:13.740208 usody_sanitize-0.1.0b2/usody_sanitize/schemas/devices.py
+-rw-r--r--   0        0        0     5368 2023-04-17 03:38:26.941252 usody_sanitize-0.1.0b2/usody_sanitize/schemas/erasure.py
+-rw-r--r--   0        0        0     3635 2023-02-03 16:48:51.000000 usody_sanitize-0.1.0b2/usody_sanitize/schemas/export_data.py
+-rwxr-xr-x   0        0        0     5412 2023-02-23 03:09:07.516501 usody_sanitize-0.1.0b2/usody_sanitize/steps.py
+-rw-r--r--   0        0        0     1487 2023-02-22 05:49:02.035640 usody_sanitize-0.1.0b2/usody_sanitize/utils.py
+-rw-r--r--   0        0        0     5331 1970-01-01 00:00:00.000000 usody_sanitize-0.1.0b2/setup.py
+-rw-r--r--   0        0        0     4923 1970-01-01 00:00:00.000000 usody_sanitize-0.1.0b2/PKG-INFO
```

### Comparing `usody_sanitize-0.1.0b1/README.md` & `usody_sanitize-0.1.0b2/README.md`
...
### Comparing `usody_sanitize-0.1.0b1/pyproject.toml` & `usody_sanitize-0.1.0b2/pyproject.toml`
...
### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/commands.py` & `usody_sanitize-0.1.0b2/usody_sanitize/commands.py`
...
### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/erasure.py` & `usody_sanitize-0.1.0b2/usody_sanitize/erasure.py`
...
### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/main.py` & `usody_sanitize-0.1.0b2/usody_sanitize/main.py`
...
### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/methods.py` & `usody_sanitize-0.1.0b2/usody_sanitize/methods.py`
...
### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/schemas/devices.py` & `usody_sanitize-0.1.0b2/usody_sanitize/schemas/devices.py`

 * *Files identical despite different names*

### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/schemas/erasure.py` & `usody_sanitize-0.1.0b2/usody_sanitize/schemas/erasure.py`
...
### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/schemas/export_data.py` & `usody_sanitize-0.1.0b2/usody_sanitize/schemas/export_data.py`

 * *Files identical despite different names*

### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/steps.py` & `usody_sanitize-0.1.0b2/usody_sanitize/steps.py`

 * *Files identical despite different names*

### Comparing `usody_sanitize-0.1.0b1/usody_sanitize/utils.py` & `usody_sanitize-0.1.0b2/usody_sanitize/utils.py`

 * *Files identical despite different names*

### Comparing `usody_sanitize-0.1.0b1/PKG-INFO` & `usody_sanitize-0.1.0b2/PKG-INFO`
