# Comparing `tmp/musicli-0.0.2.tar.gz` & `tmp/musicli-0.0.3.tar.gz`
...
## Comparing `musicli-0.0.2.tar` & `musicli-0.0.3.tar`
...
### Comparing `musicli-0.0.2/pyproject.toml` & `musicli-0.0.3/pyproject.toml`
...
### Comparing `musicli-0.0.2/README.md` & `musicli-0.0.3/README.md`

 * *Files identical despite different names*

### Comparing `musicli-0.0.2/src/musicli/musicli.py` & `musicli-0.0.3/src/musicli/musicli.py`

 * *Files identical despite different names*

### Comparing `musicli-0.0.2/setup.py` & `musicli-0.0.3/setup.py`
...
### Comparing `musicli-0.0.2/PKG-INFO` & `musicli-0.0.3/PKG-INFO`
