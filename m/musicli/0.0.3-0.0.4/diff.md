# Comparing `tmp/musicli-0.0.3.tar.gz` & `tmp/musicli-0.0.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "musicli-0.0.3.tar", max compression
+gzip compressed data, was "musicli-0.0.4.tar", max compression
```

## Comparing `musicli-0.0.3.tar` & `musicli-0.0.4.tar`

### file list

```diff
@@ -1,5 +1,5 @@
--rw-r--r--   0        0        0     2379 2023-04-19 14:46:42.607740 musicli-0.0.3/pyproject.toml
--rw-r--r--   0        0        0     3788 2023-04-18 11:39:08.644573 musicli-0.0.3/README.md
--rw-r--r--   0        0        0     9809 2023-04-19 14:24:04.050243 musicli-0.0.3/src/musicli/musicli.py
--rw-r--r--   0        0        0     4689 1970-01-01 00:00:00.000000 musicli-0.0.3/setup.py
--rw-r--r--   0        0        0     5021 1970-01-01 00:00:00.000000 musicli-0.0.3/PKG-INFO
+-rw-r--r--   0        0        0     2379 2023-04-19 14:54:43.545225 musicli-0.0.4/pyproject.toml
+-rw-r--r--   0        0        0     3913 2023-04-19 14:51:53.027814 musicli-0.0.4/README.md
+-rw-r--r--   0        0        0     9859 2023-04-19 14:53:00.414372 musicli-0.0.4/src/musicli/musicli.py
+-rw-r--r--   0        0        0     4814 1970-01-01 00:00:00.000000 musicli-0.0.4/setup.py
+-rw-r--r--   0        0        0     5138 1970-01-01 00:00:00.000000 musicli-0.0.4/PKG-INFO
```

### Comparing `musicli-0.0.3/pyproject.toml` & `musicli-0.0.4/pyproject.toml`
...
### Comparing `musicli-0.0.3/README.md` & `musicli-0.0.4/README.md`
...
### Comparing `musicli-0.0.3/src/musicli/musicli.py` & `musicli-0.0.4/src/musicli/musicli.py`
...
### Comparing `musicli-0.0.3/setup.py` & `musicli-0.0.4/setup.py`
...
### Comparing `musicli-0.0.3/PKG-INFO` & `musicli-0.0.4/PKG-INFO`
