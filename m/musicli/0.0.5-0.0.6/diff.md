# Comparing `tmp/musicli-0.0.5.tar.gz` & `tmp/musicli-0.0.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "musicli-0.0.5.tar", max compression
+gzip compressed data, was "musicli-0.0.6.tar", max compression
```

## Comparing `musicli-0.0.5.tar` & `musicli-0.0.6.tar`

### file list

```diff
@@ -1,5 +1,5 @@
--rw-r--r--   0        0        0     2379 2023-04-19 14:59:19.343273 musicli-0.0.5/pyproject.toml
--rw-r--r--   0        0        0     4107 2023-04-19 14:55:55.219812 musicli-0.0.5/README.md
--rw-r--r--   0        0        0     9892 2023-04-19 14:59:12.752345 musicli-0.0.5/src/musicli/musicli.py
--rw-r--r--   0        0        0     5008 1970-01-01 00:00:00.000000 musicli-0.0.5/setup.py
--rw-r--r--   0        0        0     5321 1970-01-01 00:00:00.000000 musicli-0.0.5/PKG-INFO
+-rw-r--r--   0        0        0     2379 2023-04-19 15:01:47.473583 musicli-0.0.6/pyproject.toml
+-rw-r--r--   0        0        0     4107 2023-04-19 14:55:55.219812 musicli-0.0.6/README.md
+-rw-r--r--   0        0        0     9890 2023-04-19 15:01:29.288241 musicli-0.0.6/src/musicli/musicli.py
+-rw-r--r--   0        0        0     5008 1970-01-01 00:00:00.000000 musicli-0.0.6/setup.py
+-rw-r--r--   0        0        0     5321 1970-01-01 00:00:00.000000 musicli-0.0.6/PKG-INFO
```

### Comparing `musicli-0.0.5/pyproject.toml` & `musicli-0.0.6/pyproject.toml`
...
### Comparing `musicli-0.0.5/README.md` & `musicli-0.0.6/README.md`

 * *Files identical despite different names*

### Comparing `musicli-0.0.5/src/musicli/musicli.py` & `musicli-0.0.6/src/musicli/musicli.py`
...
### Comparing `musicli-0.0.5/setup.py` & `musicli-0.0.6/setup.py`
...
### Comparing `musicli-0.0.5/PKG-INFO` & `musicli-0.0.6/PKG-INFO`
