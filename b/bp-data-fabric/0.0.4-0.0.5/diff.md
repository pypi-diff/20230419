# Comparing `tmp/bp_data_fabric-0.0.4.tar.gz` & `tmp/bp_data_fabric-0.0.5.tar.gz`
...
## Comparing `bp_data_fabric-0.0.4.tar` & `bp_data_fabric-0.0.5.tar`
...
### Comparing `bp_data_fabric-0.0.4/LICENSE` & `bp_data_fabric-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `bp_data_fabric-0.0.4/data_fabric/__init__.py` & `bp_data_fabric-0.0.5/data_fabric/__init__.py`

 * *Files identical despite different names*

### Comparing `bp_data_fabric-0.0.4/setup.py` & `bp_data_fabric-0.0.5/setup.py`
