# Comparing `tmp/edc-0.4.80.tar.gz` & `tmp/edc-0.4.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "edc-0.4.80.tar", last modified: Wed Apr 19 03:06:04 2023, max compression
+gzip compressed data, was "edc-0.4.9.tar", last modified: Mon Aug 15 01:45:03 2022, max compression
```

## Comparing `edc-0.4.80.tar` & `edc-0.4.9.tar`

### file list

```diff
@@ -1,76 +1,72 @@
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.374074 edc-0.4.80/
--rw-r--r--   0 erikvw     (501) staff       (20)     1410 2022-05-03 03:22:05.000000 edc-0.4.80/.gitignore
--rw-r--r--   0 erikvw     (501) staff       (20)     1076 2023-02-28 00:26:10.000000 edc-0.4.80/.pre-commit-config.yaml
--rw-r--r--   0 erikvw     (501) staff       (20)      291 2022-08-08 18:50:02.000000 edc-0.4.80/.yamllint
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2022-05-03 03:22:05.000000 edc-0.4.80/AUTHORS
--rw-r--r--   0 erikvw     (501) staff       (20)    37555 2023-04-19 03:05:56.000000 edc-0.4.80/CHANGES
--rw-r--r--   0 erikvw     (501) staff       (20)    35147 2020-03-07 14:11:38.000000 edc-0.4.80/LICENSE
--rw-r--r--   0 erikvw     (501) staff       (20)      151 2020-03-07 14:11:38.000000 edc-0.4.80/MANIFEST.in
--rw-r--r--   0 erikvw     (501) staff       (20)    38295 2023-04-19 03:06:04.374215 edc-0.4.80/PKG-INFO
--rw-r--r--   0 erikvw     (501) staff       (20)    37432 2022-11-29 06:04:52.000000 edc-0.4.80/README.rst
--rw-r--r--   0 erikvw     (501) staff       (20)        6 2022-10-14 13:05:48.000000 edc-0.4.80/VERSION
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.360185 edc-0.4.80/bin/
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.363445 edc-0.4.80/bin/nginx/
--rw-r--r--   0 erikvw     (501) staff       (20)      350 2022-07-30 01:15:42.000000 edc-0.4.80/bin/nginx/edc-sites.conf
--rw-r--r--   0 erikvw     (501) staff       (20)      706 2022-07-30 01:15:42.000000 edc-0.4.80/bin/nginx/edc-uat.conf
--rw-r--r--   0 erikvw     (501) staff       (20)      656 2022-07-30 01:15:42.000000 edc-0.4.80/bin/nginx/edc.conf
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.364117 edc-0.4.80/bin/scripts/
--rw-r--r--   0 erikvw     (501) staff       (20)     2753 2022-10-05 21:50:32.000000 edc-0.4.80/bin/scripts/dev_repos.sh
--rw-r--r--   0 erikvw     (501) staff       (20)      276 2020-03-07 14:11:38.000000 edc-0.4.80/bin/scripts/list_db_files.sh
--rw-r--r--   0 erikvw     (501) staff       (20)      416 2020-03-07 14:11:38.000000 edc-0.4.80/bin/scripts/restore_db_file.sh
--rw-r--r--   0 erikvw     (501) staff       (20)     2408 2022-07-30 01:15:42.000000 edc-0.4.80/bin/scripts/update_edc.sh
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.365284 edc-0.4.80/bin/systemd/
--rw-r--r--   0 erikvw     (501) staff       (20)      835 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/celery-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      820 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/celery.service
--rw-r--r--   0 erikvw     (501) staff       (20)      501 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/celerybeat-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      487 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/celerybeat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      485 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/gunicorn-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      121 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/gunicorn-uat.socket
--rw-r--r--   0 erikvw     (501) staff       (20)      474 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/gunicorn.service
--rw-r--r--   0 erikvw     (501) staff       (20)      111 2020-03-07 14:11:38.000000 edc-0.4.80/bin/systemd/gunicorn.socket
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.369529 edc-0.4.80/docs/
--rw-r--r--   0 erikvw     (501) staff       (20)      634 2022-09-26 00:00:10.000000 edc-0.4.80/docs/Makefile
--rw-r--r--   0 erikvw     (501) staff       (20)    12969 2023-01-25 02:44:13.000000 edc-0.4.80/docs/README.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     4441 2022-07-30 01:15:42.000000 edc-0.4.80/docs/backup.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     5437 2022-07-30 01:15:42.000000 edc-0.4.80/docs/celery.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      580 2022-07-20 12:27:13.000000 edc-0.4.80/docs/conda.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      975 2022-09-26 00:00:10.000000 edc-0.4.80/docs/conf.py
--rw-r--r--   0 erikvw     (501) staff       (20)     4806 2022-07-30 01:15:42.000000 edc-0.4.80/docs/configure_web_services.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     3646 2023-01-25 02:44:13.000000 edc-0.4.80/docs/deploy_new_droplet.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      163 2020-03-07 14:11:38.000000 edc-0.4.80/docs/dump_users.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      845 2020-03-07 14:11:38.000000 edc-0.4.80/docs/exporting_encrypted_data.rst
--rw-r--r--   0 erikvw     (501) staff       (20)   258708 2022-07-30 01:15:42.000000 edc-0.4.80/docs/forms_reference.md
--rw-r--r--   0 erikvw     (501) staff       (20)      445 2022-09-26 00:00:10.000000 edc-0.4.80/docs/index.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      778 2020-03-07 14:11:38.000000 edc-0.4.80/docs/landing_page.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      765 2022-09-26 00:00:10.000000 edc-0.4.80/docs/make.bat
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2020-04-05 21:20:27.000000 edc-0.4.80/docs/multisite_deployment.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     3928 2023-01-25 02:44:13.000000 edc-0.4.80/docs/prepare_database.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     1211 2022-07-30 01:15:42.000000 edc-0.4.80/docs/printing.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      187 2021-01-28 23:38:49.000000 edc-0.4.80/docs/redis.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      766 2020-03-07 14:11:38.000000 edc-0.4.80/docs/update_deployment.rst
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.370463 edc-0.4.80/edc.egg-info/
--rw-r--r--   0 erikvw     (501) staff       (20)    38295 2023-04-19 03:06:04.000000 edc-0.4.80/edc.egg-info/PKG-INFO
--rw-r--r--   0 erikvw     (501) staff       (20)     1516 2023-04-19 03:06:04.000000 edc-0.4.80/edc.egg-info/SOURCES.txt
--rw-r--r--   0 erikvw     (501) staff       (20)        1 2023-04-19 03:06:04.000000 edc-0.4.80/edc.egg-info/dependency_links.txt
--rw-r--r--   0 erikvw     (501) staff       (20)        1 2022-05-04 16:05:20.000000 edc-0.4.80/edc.egg-info/not-zip-safe
--rw-r--r--   0 erikvw     (501) staff       (20)     1920 2023-04-19 03:06:04.000000 edc-0.4.80/edc.egg-info/requires.txt
--rw-r--r--   0 erikvw     (501) staff       (20)        6 2023-04-19 03:06:04.000000 edc-0.4.80/edc.egg-info/top_level.txt
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.370575 edc-0.4.80/image/
--rw-r--r--   0 erikvw     (501) staff       (20)   160721 2022-03-16 23:21:44.000000 edc-0.4.80/image/icon-pycharm.png
--rw-r--r--   0 erikvw     (501) staff       (20)      162 2022-05-04 16:05:08.000000 edc-0.4.80/pyproject.toml
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.373484 edc-0.4.80/requirements.tests/
--rw-r--r--   0 erikvw     (501) staff       (20)       21 2022-08-12 15:19:56.000000 edc-0.4.80/requirements.tests/coverage.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       14 2022-08-10 01:27:44.000000 edc-0.4.80/requirements.tests/docs.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     1053 2023-04-19 03:05:56.000000 edc-0.4.80/requirements.tests/edc.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     4100 2022-09-27 03:34:08.000000 edc-0.4.80/requirements.tests/edc_dev.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       68 2021-04-15 14:46:29.000000 edc-0.4.80/requirements.tests/edc_offline.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       54 2022-08-12 15:19:56.000000 edc-0.4.80/requirements.tests/lint.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       11 2022-07-30 01:15:42.000000 edc-0.4.80/requirements.tests/mysql.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       22 2021-01-28 19:17:27.000000 edc-0.4.80/requirements.tests/postgres.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       86 2022-07-30 01:15:42.000000 edc-0.4.80/requirements.tests/test_utils.txt
--rw-r--r--   0 erikvw     (501) staff       (20)      238 2022-08-23 12:40:42.000000 edc-0.4.80/requirements.tests/third_party_dev.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       50 2022-05-03 03:22:05.000000 edc-0.4.80/requirements.tests/tox.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     2992 2023-04-19 03:06:04.374683 edc-0.4.80/setup.cfg
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-04-19 03:06:04.373814 edc-0.4.80/utils/
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2021-02-09 03:49:51.000000 edc-0.4.80/utils/__init__.py
--rw-r--r--   0 erikvw     (501) staff       (20)      721 2022-05-03 03:22:05.000000 edc-0.4.80/utils/get_edc_requirements.py
...
### Comparing `edc-0.4.80/.gitignore` & `edc-0.4.9/.gitignore`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/.pre-commit-config.yaml` & `edc-0.4.9/.pre-commit-config.yaml`
...
### Comparing `edc-0.4.80/CHANGES` & `edc-0.4.9/CHANGES`
...
### Comparing `edc-0.4.80/LICENSE` & `edc-0.4.9/LICENSE`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/PKG-INFO` & `edc-0.4.9/PKG-INFO`
...
### Comparing `edc-0.4.80/README.rst` & `edc-0.4.9/edc.egg-info/PKG-INFO`
...
### Comparing `edc-0.4.80/bin/nginx/edc-uat.conf` & `edc-0.4.9/bin/nginx/edc-uat.conf`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/bin/nginx/edc.conf` & `edc-0.4.9/bin/nginx/edc.conf`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/bin/scripts/dev_repos.sh` & `edc-0.4.9/bin/scripts/dev_repos.sh`
...
### Comparing `edc-0.4.80/bin/scripts/update_edc.sh` & `edc-0.4.9/bin/scripts/update_edc.sh`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/bin/systemd/celery-uat.service` & `edc-0.4.9/bin/systemd/celery-uat.service`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/bin/systemd/celery.service` & `edc-0.4.9/bin/systemd/celery.service`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/backup.rst` & `edc-0.4.9/docs/backup.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/celery.rst` & `edc-0.4.9/docs/celery.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/conda.rst` & `edc-0.4.9/docs/conda.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/configure_web_services.rst` & `edc-0.4.9/docs/configure_web_services.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/deploy_new_droplet.rst` & `edc-0.4.9/docs/deploy_new_droplet.rst`
...
### Comparing `edc-0.4.80/docs/exporting_encrypted_data.rst` & `edc-0.4.9/docs/exporting_encrypted_data.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/forms_reference.md` & `edc-0.4.9/docs/forms_reference.md`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/landing_page.rst` & `edc-0.4.9/docs/landing_page.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/printing.rst` & `edc-0.4.9/docs/printing.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/docs/update_deployment.rst` & `edc-0.4.9/docs/update_deployment.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/edc.egg-info/PKG-INFO` & `edc-0.4.9/README.rst`
...
### Comparing `edc-0.4.80/edc.egg-info/SOURCES.txt` & `edc-0.4.9/edc.egg-info/SOURCES.txt`
...
### Comparing `edc-0.4.80/edc.egg-info/requires.txt` & `edc-0.4.9/edc.egg-info/requires.txt`
...
-edc-adverse-event==0.3.46
-edc-appointment==0.3.67
-edc-auth==0.3.58
-edc-consent==0.3.42
...
-edc-qol==0.1.9
-edc-randomization==0.3.44
-edc-reference==0.3.14
-edc-refusal==0.1.10
-edc-registration==0.3.25
...
### Comparing `edc-0.4.80/image/icon-pycharm.png` & `edc-0.4.9/image/icon-pycharm.png`

 * *Files identical despite different names*

### Comparing `edc-0.4.80/requirements.tests/edc.txt` & `edc-0.4.9/requirements.tests/edc.txt`
...
### Comparing `edc-0.4.80/requirements.tests/edc_dev.txt` & `edc-0.4.9/requirements.tests/edc_dev.txt`
...
### Comparing `edc-0.4.80/setup.cfg` & `edc-0.4.9/setup.cfg`
...
### Comparing `edc-0.4.80/utils/get_edc_requirements.py` & `edc-0.4.9/utils/get_edc_requirements.py`
