# Comparing `tmp/nlptoolssna-0.3.1.tar.gz` & `tmp/nlptoolssna-0.3.2.tar.gz`
...
### Comparing `nlptoolssna-0.3.1/nlptoolssna.egg-info/SOURCES.txt` & `nlptoolssna-0.3.2/nlptoolssna.egg-info/SOURCES.txt`
