# Comparing `tmp/naruno_gui-0.56.6.tar.gz` & `tmp/naruno_gui-0.56.7.tar.gz`
...
## Comparing `naruno_gui-0.56.6.tar` & `naruno_gui-0.56.7.tar`
...
### Comparing `naruno_gui-0.56.6/setup.py` & `naruno_gui-0.56.7/setup.py`
