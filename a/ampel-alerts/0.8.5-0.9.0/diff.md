# Comparing `tmp/ampel_alerts-0.8.5.tar.gz` & `tmp/ampel_alerts-0.9.0.tar.gz`
...
### Comparing `ampel_alerts-0.8.5/ampel/alert/AlertConsumerError.py` & `ampel_alerts-0.9.0/ampel/alert/AlertConsumerError.py`
