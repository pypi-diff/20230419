# Comparing `tmp/hive-maia-1.0.tar.gz` & `tmp/hive-maia-1.1.tar.gz`
...
+gzip compressed data, was "hive-maia-1.1.tar", last modified: Wed Apr 19 13:33:10 2023, max compression
```

## Comparing `hive-maia-1.0.tar` & `hive-maia-1.1.tar`
...
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.984204 hive-maia-1.1/
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.980204 hive-maia-1.1/Hive/
+-rw-rw-r--   0 simone    (1000) simone    (1000)      554 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive/__init__.py
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.980204 hive-maia-1.1/Hive/configs/
+-rw-rw-r--   0 simone    (1000) simone    (1000)      458 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/configs/ATM_nnUNet_3D_fullres_config.json
+-rw-rw-r--   0 simone    (1000) simone    (1000)      301 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/configs/AutoPET_Positive_nnDet_3D_fullres_config.json
+-rw-rw-r--   0 simone    (1000) simone    (1000)      883 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/configs/LungLobeSeg_nnUNet_3D_fullres_In_config.json
+-rw-rw-r--   0 simone    (1000) simone    (1000)      272 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/configs/LymphNodeSeg_ABD_nnDet_3D_fullres_config.json
+-rw-rw-r--   0 simone    (1000) simone    (1000)      272 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/configs/LymphNodeSeg_MED_nnDet_3D_fullres_config.json
+-rw-rw-r--   0 simone    (1000) simone    (1000)        0 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive/configs/__init__.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1043 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/configs/nnDet_config_template.json
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.980204 hive-maia-1.1/Hive/evaluation/
+-rw-rw-r--   0 simone    (1000) simone    (1000)        1 2023-04-19 12:06:26.000000 hive-maia-1.1/Hive/evaluation/__init__.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3946 2023-04-19 12:57:19.000000 hive-maia-1.1/Hive/evaluation/abstract.py
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.980204 hive-maia-1.1/Hive/evaluation/detection/
+-rw-rw-r--   0 simone    (1000) simone    (1000)        1 2023-04-19 12:49:04.000000 hive-maia-1.1/Hive/evaluation/detection/__init__.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)    16106 2023-04-19 12:57:19.000000 hive-maia-1.1/Hive/evaluation/detection/coco.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)    15779 2023-04-19 12:57:19.000000 hive-maia-1.1/Hive/evaluation/detection/froc.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     7868 2023-04-19 12:57:19.000000 hive-maia-1.1/Hive/evaluation/detection/hist.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)    11722 2023-04-19 12:57:19.000000 hive-maia-1.1/Hive/evaluation/detection/matching.py
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.980204 hive-maia-1.1/Hive/utils/
+-rw-rw-r--   0 simone    (1000) simone    (1000)        0 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive/utils/__init__.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)    23403 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/utils/file_utils.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1978 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive/utils/log_utils.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1484 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive/utils/seg_mask_utils.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)    12126 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive/utils/volume_utils.py
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.984204 hive-maia-1.1/Hive_scripts/
+-rw-rw-r--   0 simone    (1000) simone    (1000)     6963 2023-04-19 13:12:18.000000 hive-maia-1.1/Hive_scripts/Hive_convert_DICOM_dataset_to_NIFTI_dataset.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1204 2023-04-19 13:12:19.000000 hive-maia-1.1/Hive_scripts/Hive_convert_NIFTI_predictions_to_DICOM_SEG.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3080 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/Hive_convert_semantic_to_instance_segmentation.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3052 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/Hive_create_subset.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     2744 2023-04-19 12:05:41.000000 hive-maia-1.1/Hive_scripts/Hive_extract_experiment_predictions.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     4047 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/Hive_order_data_folder.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1413 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/Hive_run_pipeline_from_file.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)        0 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/__init__.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)    11048 2023-04-19 13:05:53.000000 hive-maia-1.1/Hive_scripts/nndet_compute_metric_results.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     5067 2023-04-19 12:06:27.000000 hive-maia-1.1/Hive_scripts/nndet_create_pipeline.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     8268 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/nndet_prepare_data_folder.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     2744 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/nndet_run_preprocessing.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3296 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/nndet_run_training.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     8706 2023-04-19 13:12:19.000000 hive-maia-1.1/Hive_scripts/nnunet_prepare_data_folder.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3645 2023-04-19 13:12:19.000000 hive-maia-1.1/Hive_scripts/nnunet_run_prediction.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     2064 2023-04-19 13:12:19.000000 hive-maia-1.1/Hive_scripts/nnunet_run_preprocessing.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3996 2023-04-19 13:12:19.000000 hive-maia-1.1/Hive_scripts/nnunet_run_training.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1139 2023-01-18 15:13:07.000000 hive-maia-1.1/Hive_scripts/script_template.py
+-rw-rw-r--   0 simone    (1000) simone    (1000)     3471 2023-04-19 13:12:19.000000 hive-maia-1.1/Hive_scripts/upload_DICOM_to_Orthanc.py
+-rwxrwxr-x   0 simone    (1000) simone    (1000)    35149 2023-01-18 15:01:57.000000 hive-maia-1.1/LICENSE
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1645 2023-04-19 13:33:10.984204 hive-maia-1.1/PKG-INFO
+-rwxrwxr-x   0 simone    (1000) simone    (1000)      914 2023-01-18 15:13:07.000000 hive-maia-1.1/README.md
+-rw-rw-r--   0 simone    (1000) simone    (1000)        3 2023-04-19 13:14:57.000000 hive-maia-1.1/VERSION
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.984204 hive-maia-1.1/hive_maia.egg-info/
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1645 2023-04-19 13:33:10.000000 hive-maia-1.1/hive_maia.egg-info/PKG-INFO
+-rw-rw-r--   0 simone    (1000) simone    (1000)     1825 2023-04-19 13:33:10.000000 hive-maia-1.1/hive_maia.egg-info/SOURCES.txt
+-rw-rw-r--   0 simone    (1000) simone    (1000)        1 2023-04-19 13:33:10.000000 hive-maia-1.1/hive_maia.egg-info/dependency_links.txt
+-rw-rw-r--   0 simone    (1000) simone    (1000)      872 2023-04-19 13:33:10.000000 hive-maia-1.1/hive_maia.egg-info/entry_points.txt
+-rw-rw-r--   0 simone    (1000) simone    (1000)      133 2023-04-19 13:33:10.000000 hive-maia-1.1/hive_maia.egg-info/requires.txt
+-rw-rw-r--   0 simone    (1000) simone    (1000)       18 2023-04-19 13:33:10.000000 hive-maia-1.1/hive_maia.egg-info/top_level.txt
+-rwxrwxr-x   0 simone    (1000) simone    (1000)      330 2023-01-18 15:01:52.000000 hive-maia-1.1/pyproject.toml
+-rw-rw-r--   0 simone    (1000) simone    (1000)      132 2023-04-19 13:12:49.000000 hive-maia-1.1/requirements.txt
+-rw-rw-r--   0 simone    (1000) simone    (1000)       38 2023-04-19 13:33:10.984204 hive-maia-1.1/setup.cfg
+-rw-rw-r--   0 simone    (1000) simone    (1000)     2936 2023-04-19 13:33:02.000000 hive-maia-1.1/setup.py
+drwxrwxr-x   0 simone    (1000) simone    (1000)        0 2023-04-19 13:33:10.984204 hive-maia-1.1/tests/
+-rw-rw-r--   0 simone    (1000) simone    (1000)      157 2023-04-19 13:12:19.000000 hive-maia-1.1/tests/test_file_utils.py
```

### Comparing `hive-maia-1.0/Hive/__init__.py` & `hive-maia-1.1/Hive/__init__.py`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/Hive/configs/nnDet_config_template.json` & `hive-maia-1.1/Hive/configs/nnDet_config_template.json`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/Hive/utils/log_utils.py` & `hive-maia-1.1/Hive/utils/log_utils.py`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/Hive/utils/seg_mask_utils.py` & `hive-maia-1.1/Hive/utils/seg_mask_utils.py`
...
### Comparing `hive-maia-1.0/Hive/utils/volume_utils.py` & `hive-maia-1.1/Hive/utils/volume_utils.py`
...
### Comparing `hive-maia-1.0/Hive_MAIA.egg-info/PKG-INFO` & `hive-maia-1.1/PKG-INFO`
...
### Comparing `hive-maia-1.0/Hive_MAIA.egg-info/SOURCES.txt` & `hive-maia-1.1/hive_maia.egg-info/SOURCES.txt`
...
### Comparing `hive-maia-1.0/LICENSE` & `hive-maia-1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/PKG-INFO` & `hive-maia-1.1/hive_maia.egg-info/PKG-INFO`
...
### Comparing `hive-maia-1.0/README.md` & `hive-maia-1.1/README.md`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/scripts/Hive_convert_DICOM_dataset_to_NIFTI_dataset.py` & `hive-maia-1.1/Hive_scripts/nndet_run_preprocessing.py`
...
### Comparing `hive-maia-1.0/scripts/Hive_convert_semantic_to_instance_segmentation.py` & `hive-maia-1.1/Hive_scripts/Hive_convert_semantic_to_instance_segmentation.py`
...
### Comparing `hive-maia-1.0/scripts/Hive_create_subset.py` & `hive-maia-1.1/Hive_scripts/Hive_create_subset.py`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/scripts/Hive_run_pipeline_from_file.py` & `hive-maia-1.1/Hive_scripts/Hive_run_pipeline_from_file.py`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/scripts/nndet_create_pipeline.py` & `hive-maia-1.1/Hive_scripts/nndet_create_pipeline.py`
...
### Comparing `hive-maia-1.0/scripts/nndet_prepare_data_folder.py` & `hive-maia-1.1/Hive_scripts/nndet_prepare_data_folder.py`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/scripts/nndet_run_preprocessing.py` & `hive-maia-1.1/Hive_scripts/nnunet_run_preprocessing.py`
...
### Comparing `hive-maia-1.0/scripts/nndet_run_training.py` & `hive-maia-1.1/Hive_scripts/nndet_run_training.py`
...
### Comparing `hive-maia-1.0/scripts/nnunet_run_prediction.py` & `hive-maia-1.1/Hive_scripts/nnunet_run_prediction.py`
...
### Comparing `hive-maia-1.0/scripts/script_template.py` & `hive-maia-1.1/Hive_scripts/script_template.py`

 * *Files identical despite different names*

### Comparing `hive-maia-1.0/setup.py` & `hive-maia-1.1/setup.py`
