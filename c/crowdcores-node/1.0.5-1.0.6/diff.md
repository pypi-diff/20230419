# Comparing `tmp/crowdcores-node-1.0.5.tar.gz` & `tmp/crowdcores-node-1.0.6.tar.gz`
...
## Comparing `crowdcores-node-1.0.5.tar` & `crowdcores-node-1.0.6.tar`
...
### Comparing `crowdcores-node-1.0.5/LICENSE.txt` & `crowdcores-node-1.0.6/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `crowdcores-node-1.0.5/crowdcores_node/crowdcores_node.py` & `crowdcores-node-1.0.6/crowdcores_node/crowdcores_node.py`

 * *Files identical despite different names*

### Comparing `crowdcores-node-1.0.5/crowdcores_node/manager.py` & `crowdcores-node-1.0.6/crowdcores_node/manager.py`
