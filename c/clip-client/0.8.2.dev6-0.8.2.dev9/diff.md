# Comparing `tmp/clip-client-0.8.2.dev6.tar.gz` & `tmp/clip-client-0.8.2.dev9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "clip-client-0.8.2.dev6.tar", last modified: Tue Nov 29 06:53:22 2022, max compression
+gzip compressed data, was "clip-client-0.8.2.dev9.tar", last modified: Wed Dec  7 07:23:05 2022, max compression
```

## Comparing `clip-client-0.8.2.dev6.tar` & `clip-client-0.8.2.dev9.tar`

### file list

```diff
@@ -1,15 +1,15 @@
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2022-11-29 06:53:22.943309 clip-client-0.8.2.dev6/
--rw-r--r--   0 runner    (1001) docker     (122)    31330 2022-11-29 06:53:22.939309 clip-client-0.8.2.dev6/PKG-INFO
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2022-11-29 06:53:22.939309 clip-client-0.8.2.dev6/clip_client/
--rw-r--r--   0 runner    (1001) docker     (122)      226 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client/__init__.py
--rw-r--r--   0 runner    (1001) docker     (122)    35657 2022-11-29 06:53:14.000000 clip-client-0.8.2.dev6/clip_client/client.py
--rw-r--r--   0 runner    (1001) docker     (122)     1987 2022-11-29 06:53:14.000000 clip-client-0.8.2.dev6/clip_client/helper.py
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2022-11-29 06:53:22.939309 clip-client-0.8.2.dev6/clip_client.egg-info/
--rw-r--r--   0 runner    (1001) docker     (122)    31330 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      284 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (122)      179 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (122)       12 2022-11-29 06:53:22.000000 clip-client-0.8.2.dev6/clip_client.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (122)       38 2022-11-29 06:53:22.943309 clip-client-0.8.2.dev6/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (122)     3230 2022-11-29 06:53:14.000000 clip-client-0.8.2.dev6/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2022-12-07 07:23:05.968423 clip-client-0.8.2.dev9/
+-rw-r--r--   0 runner    (1001) docker     (123)    25207 2022-12-07 07:23:05.968423 clip-client-0.8.2.dev9/PKG-INFO
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2022-12-07 07:23:05.968423 clip-client-0.8.2.dev9/clip_client/
+-rw-r--r--   0 runner    (1001) docker     (123)      226 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)    35657 2022-12-07 07:23:01.000000 clip-client-0.8.2.dev9/clip_client/client.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1987 2022-12-07 07:23:01.000000 clip-client-0.8.2.dev9/clip_client/helper.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2022-12-07 07:23:05.968423 clip-client-0.8.2.dev9/clip_client.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)    25207 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      284 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)      180 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       12 2022-12-07 07:23:05.000000 clip-client-0.8.2.dev9/clip_client.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2022-12-07 07:23:05.968423 clip-client-0.8.2.dev9/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     3231 2022-12-07 07:23:01.000000 clip-client-0.8.2.dev9/setup.py
```

### Comparing `clip-client-0.8.2.dev6/PKG-INFO` & `clip-client-0.8.2.dev9/PKG-INFO`
...
```diff
@@ -1,14 +1,32 @@
-Metadata-Version: 2.1 Name: clip-client Version: 0.8.2.dev6 Summary: Embed
+Metadata-Version: 2.1 Name: clip-client Version: 0.8.2.dev9 Summary: Embed
...
### Comparing `clip-client-0.8.2.dev6/clip_client/client.py` & `clip-client-0.8.2.dev9/clip_client/client.py`

 * *Files identical despite different names*

### Comparing `clip-client-0.8.2.dev6/clip_client/helper.py` & `clip-client-0.8.2.dev9/clip_client/helper.py`

 * *Files identical despite different names*

### Comparing `clip-client-0.8.2.dev6/clip_client.egg-info/PKG-INFO` & `clip-client-0.8.2.dev9/clip_client.egg-info/PKG-INFO`
...
### Comparing `clip-client-0.8.2.dev6/setup.py` & `clip-client-0.8.2.dev9/setup.py`
