# Comparing `tmp/cads_sdk-0.0.12rc0-py3-none-any.whl.zip` & `tmp/cads_sdk-0.0.5-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,33 +1,28 @@
-Zip file size: 85194 bytes, number of entries: 31
--rw-rw-r--  2.0 unx     1268 b- defN 23-Apr-10 14:26 cads_sdk/__init__.py
...
--rw-rw-r--  2.0 unx    11801 b- defN 23-Apr-07 16:29 cads_sdk/nosql/codec.py
--rw-rw-r--  2.0 unx    79647 b- defN 23-Apr-10 15:27 cads_sdk/nosql/converter.py
--rw-rw-r--  2.0 unx    19500 b- defN 23-Apr-10 11:36 cads_sdk/nosql/display.py
...
--rw-rw-r--  2.0 unx     7012 b- defN 23-Apr-10 15:27 cads_sdk-0.0.12rc0.dist-info/METADATA
--rw-rw-r--  2.0 unx       92 b- defN 23-Apr-10 15:27 cads_sdk-0.0.12rc0.dist-info/WHEEL
--rw-rw-r--  2.0 unx        9 b- defN 23-Apr-10 15:27 cads_sdk-0.0.12rc0.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     2552 b- defN 23-Apr-10 15:27 cads_sdk-0.0.12rc0.dist-info/RECORD
-31 files, 358583 bytes uncompressed, 81130 bytes compressed:  77.4%
...
-Filename: cads_sdk-0.0.12rc0.dist-info/METADATA
+Filename: cads_sdk-0.0.5.dist-info/METADATA
 Comment: 
 
-Filename: cads_sdk-0.0.12rc0.dist-info/WHEEL
+Filename: cads_sdk-0.0.5.dist-info/WHEEL
 Comment: 
 
-Filename: cads_sdk-0.0.12rc0.dist-info/top_level.txt
+Filename: cads_sdk-0.0.5.dist-info/top_level.txt
 Comment: 
 
-Filename: cads_sdk-0.0.12rc0.dist-info/RECORD
...
-        return table_name
-            
-    def get_num_partition(self, input_files, ROWGROUP_SIZE_MB = 256):
-        memory = get_size_of_list(input_files)
...
-        if self.dict_image[s]:
-            Schema = self.create_image_schema(s, self.image_type, self.image_color)
-            self.numPartition = self.get_num_partition(self.input_path)
-            self.output_path = self.convert_to_hdfs_path(self.output_path)
-            output_path = self._generate_output_path(s)
-            table_name = self._generate_table_name(s)
-            spark = self.get_spark()
...
## Comparing `cads_sdk-0.0.12rc0.dist-info/METADATA` & `cads_sdk-0.0.5.dist-info/METADATA`
...
+Requires-Dist: spark-sdk (>=0.4.19)
 ...
 # cads-sdk: Functions to help Data Scientist work more effectively with unstructured data and datalake
-[![PyPI Latest Release](https://img.shields.io/badge/pypi-0.0.12rc0-blue)](https://pypi.org/project/cads-sdk/)
