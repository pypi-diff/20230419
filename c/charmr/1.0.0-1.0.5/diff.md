# Comparing `tmp/charmr-1.0.0.tar.gz` & `tmp/charmr-1.0.5.tar.gz`
...
+gzip compressed data, was "charmr-1.0.5.tar", last modified: Wed Apr 19 03:03:31 2023, max compression
```

## Comparing `charmr-1.0.0.tar` & `charmr-1.0.5.tar`
...
+drwxr-xr-x   0 ronharlev   (501) staff       (20)        0 2023-04-19 03:03:31.681666 charmr-1.0.5/
+-rw-r--r--   0 ronharlev   (501) staff       (20)     3952 2023-04-19 03:03:31.681091 charmr-1.0.5/PKG-INFO
+-rw-r--r--   0 ronharlev   (501) staff       (20)     3694 2023-04-19 02:57:00.000000 charmr-1.0.5/README.md
+drwxr-xr-x   0 ronharlev   (501) staff       (20)        0 2023-04-19 03:03:31.677429 charmr-1.0.5/charmr/
+-rw-r--r--   0 ronharlev   (501) staff       (20)        0 2023-04-14 03:06:02.000000 charmr-1.0.5/charmr/__init__.py
+-rw-r--r--   0 ronharlev   (501) staff       (20)     1455 2023-04-19 02:21:55.000000 charmr-1.0.5/charmr/ai.py
+-rw-r--r--   0 ronharlev   (501) staff       (20)     1096 2023-03-14 23:17:20.000000 charmr-1.0.5/charmr/alias_manager.py
+-rw-r--r--   0 ronharlev   (501) staff       (20)      572 2023-04-19 02:31:54.000000 charmr-1.0.5/charmr/load_code.py
+-rw-r--r--   0 ronharlev   (501) staff       (20)     2755 2023-04-19 02:40:56.000000 charmr-1.0.5/charmr/main.py
+drwxr-xr-x   0 ronharlev   (501) staff       (20)        0 2023-04-19 03:03:31.680510 charmr-1.0.5/charmr.egg-info/
+-rw-r--r--   0 ronharlev   (501) staff       (20)     3952 2023-04-19 03:03:31.000000 charmr-1.0.5/charmr.egg-info/PKG-INFO
+-rw-r--r--   0 ronharlev   (501) staff       (20)      291 2023-04-19 03:03:31.000000 charmr-1.0.5/charmr.egg-info/SOURCES.txt
+-rw-r--r--   0 ronharlev   (501) staff       (20)        1 2023-04-19 03:03:31.000000 charmr-1.0.5/charmr.egg-info/dependency_links.txt
+-rw-r--r--   0 ronharlev   (501) staff       (20)       44 2023-04-19 03:03:31.000000 charmr-1.0.5/charmr.egg-info/entry_points.txt
+-rw-r--r--   0 ronharlev   (501) staff       (20)       21 2023-04-19 03:03:31.000000 charmr-1.0.5/charmr.egg-info/requires.txt
+-rw-r--r--   0 ronharlev   (501) staff       (20)        7 2023-04-19 03:03:31.000000 charmr-1.0.5/charmr.egg-info/top_level.txt
+-rw-r--r--   0 ronharlev   (501) staff       (20)       38 2023-04-19 03:03:31.681850 charmr-1.0.5/setup.cfg
+-rw-r--r--   0 ronharlev   (501) staff       (20)      658 2023-04-19 03:03:12.000000 charmr-1.0.5/setup.py
```

### Comparing `charmr-1.0.0/charmr/ai.py` & `charmr-1.0.5/charmr/ai.py`
...
### Comparing `charmr-1.0.0/charmr/alias_manager.py` & `charmr-1.0.5/charmr/alias_manager.py`

 * *Files identical despite different names*

### Comparing `charmr-1.0.0/charmr/load_code.py` & `charmr-1.0.5/charmr/load_code.py`
...
### Comparing `charmr-1.0.0/charmr/main.py` & `charmr-1.0.5/charmr/main.py`
...
### Comparing `charmr-1.0.0/setup.py` & `charmr-1.0.5/setup.py`
