# Comparing `tmp/clip-as-service-0.8.2.dev6.tar.gz` & `tmp/clip-as-service-0.8.2.dev9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "clip-as-service-0.8.2.dev6.tar", last modified: Tue Nov 29 06:53:29 2022, max compression
+gzip compressed data, was "clip-as-service-0.8.2.dev9.tar", last modified: Wed Dec  7 07:23:11 2022, max compression
```

## Comparing `clip-as-service-0.8.2.dev6.tar` & `clip-as-service-0.8.2.dev9.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2022-11-29 06:53:29.943504 clip-as-service-0.8.2.dev6/
--rw-r--r--   0 runner    (1001) docker     (122)    11045 2022-11-29 06:53:14.000000 clip-as-service-0.8.2.dev6/LICENSE
--rw-r--r--   0 runner    (1001) docker     (122)       45 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (122)    31262 2022-11-29 06:53:29.943504 clip-as-service-0.8.2.dev6/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)    23383 2022-11-29 06:53:14.000000 clip-as-service-0.8.2.dev6/README.md
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2022-11-29 06:53:29.943504 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/
--rw-r--r--   0 runner    (1001) docker     (122)    31262 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      270 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (122)       24 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (122)        6 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/clip_as_service.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (122)       38 2022-11-29 06:53:29.943504 clip-as-service-0.8.2.dev6/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (122)     2771 2022-11-29 06:53:29.000000 clip-as-service-0.8.2.dev6/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2022-12-07 07:23:11.420495 clip-as-service-0.8.2.dev9/
+-rw-r--r--   0 runner    (1001) docker     (123)    11045 2022-12-07 07:23:01.000000 clip-as-service-0.8.2.dev9/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)       45 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (123)    25161 2022-12-07 07:23:11.420495 clip-as-service-0.8.2.dev9/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)    23383 2022-12-07 07:23:01.000000 clip-as-service-0.8.2.dev9/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2022-12-07 07:23:11.420495 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)    25161 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      270 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)       24 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        6 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/clip_as_service.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2022-12-07 07:23:11.420495 clip-as-service-0.8.2.dev9/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     2771 2022-12-07 07:23:11.000000 clip-as-service-0.8.2.dev9/setup.py
```

### Comparing `clip-as-service-0.8.2.dev6/LICENSE` & `clip-as-service-0.8.2.dev9/LICENSE`

 * *Files identical despite different names*

### Comparing `clip-as-service-0.8.2.dev6/PKG-INFO` & `clip-as-service-0.8.2.dev9/PKG-INFO`
...
```diff
@@ -1,14 +1,31 @@
-Metadata-Version: 2.1 Name: clip-as-service Version: 0.8.2.dev6 Summary: Embed
+Metadata-Version: 2.1 Name: clip-as-service Version: 0.8.2.dev9 Summary: Embed
 ...
 Source, https://github.com/jina-ai/clip-as-service Project-URL: Tracker, https:
-//github.com/jina-ai/clip-as-service/issues Description:
+//github.com/jina-ai/clip-as-service/issues Keywords: jina openai clip deep-
+learning cross-modal multi-modal neural-search Platform: UNKNOWN Classifier:
+Development Status :: 5 - Production/Stable Classifier: Intended Audience ::
+Developers Classifier: Intended Audience :: Education Classifier: Intended
+Audience :: Science/Research Classifier: Programming Language :: Python :: 3.7
+Classifier: Programming Language :: Python :: 3.8 Classifier: Programming
+Language :: Python :: 3.9 Classifier: Programming Language :: Unix Shell
...
-Python :: 3.9 Classifier: Programming Language :: Unix Shell Classifier:
...
-Mathematics Classifier: Topic :: Software Development Classifier: Topic ::
-Software Development :: Libraries Classifier: Topic :: Software Development ::
-Libraries :: Python Modules Description-Content-Type: text/markdown
+open-source.
```

### Comparing `clip-as-service-0.8.2.dev6/README.md` & `clip-as-service-0.8.2.dev9/README.md`

 * *Files identical despite different names*

### Comparing `clip-as-service-0.8.2.dev6/clip_as_service.egg-info/PKG-INFO` & `clip-as-service-0.8.2.dev9/clip_as_service.egg-info/PKG-INFO`
...
### Comparing `clip-as-service-0.8.2.dev6/setup.py` & `clip-as-service-0.8.2.dev9/setup.py`
