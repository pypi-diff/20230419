# Comparing `tmp/girder-slicer-cli-web-1.3.2.dev6.tar.gz` & `tmp/girder-slicer-cli-web-1.3.3.dev2.tar.gz`
...
### Comparing `girder-slicer-cli-web-1.3.2.dev6/.dockerignore` & `girder-slicer-cli-web-1.3.3.dev2/.dockerignore`
...
### Comparing `girder-slicer-cli-web-1.3.2.dev6/girder_slicer_cli_web.egg-info/SOURCES.txt` & `girder-slicer-cli-web-1.3.3.dev2/girder_slicer_cli_web.egg-info/SOURCES.txt`
...
### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/girder_worker_plugin/__init__.py` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/girder_worker_plugin/__init__.py`
...
### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/parser/group.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/parser/group.js`
...
### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/templates/widget.pug` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/templates/widget.pug`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/utils.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/utils.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/CollectionView.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/CollectionView.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/ConfigView.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/ConfigView.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/ControlWidget.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/ControlWidget.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/ControlsPanel.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/ControlsPanel.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/ItemSelectorWidget.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/ItemSelectorWidget.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/ItemView.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/ItemView.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/JobsListWidget.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/JobsListWidget.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/JobsPanel.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/JobsPanel.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/OutputParameterDialog.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/OutputParameterDialog.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/Panel.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/Panel.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/PanelGroup.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/PanelGroup.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/web_client/views/utils.js` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/web_client/views/utils.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/slicer_cli_web/worker_tools.py` & `girder-slicer-cli-web-1.3.3.dev2/slicer_cli_web/worker_tools.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/.dockerignore` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/.dockerignore`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Dockerfile` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Dockerfile`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example1/Example1.json` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example1/Example1.json`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example1/Example1.py` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example1/Example1.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example1/Example1.xml` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example1/Example1.xml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example1/Example1.yaml` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example1/Example1.yaml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example2/Example2.json` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example2/Example2.json`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example2/Example2.py` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example2/Example2.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example2/Example2.xml` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example2/Example2.xml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example2/Example2.yaml` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example2/Example2.yaml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example3/Example3.json` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example3/Example3.json`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example3/Example3.py` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example3/Example3.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example3/Example3.xml` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example3/Example3.xml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/Example3/Example3.yaml` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/Example3/Example3.yaml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/ExampleProgress/ExampleProgress.json` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/ExampleProgress/ExampleProgress.json`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/ExampleProgress/ExampleProgress.py` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/ExampleProgress/ExampleProgress.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/ExampleProgress/progress_helper.py` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/ExampleProgress/progress_helper.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/cli_list.json` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/cli_list.json`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/small-docker/cli_list.py` & `girder-slicer-cli-web-1.3.3.dev2/small-docker/cli_list.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/conftest.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/data/ExampleSpec.xml` & `girder-slicer-cli-web-1.3.3.dev2/tests/data/ExampleSpec.xml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/data/parser_params_advanced.json` & `girder-slicer-cli-web-1.3.3.dev2/tests/data/parser_params_advanced.json`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/data/parser_params_advanced.xml` & `girder-slicer-cli-web-1.3.3.dev2/tests/data/parser_params_advanced.xml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/data/parser_params_advanced.yaml` & `girder-slicer-cli-web-1.3.3.dev2/tests/data/parser_params_advanced.yaml`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/girder_worker_plugin/test_cli_progress.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/girder_worker_plugin/test_cli_progress.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/girder_worker_plugin/test_direct_docker_run.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/girder_worker_plugin/test_direct_docker_run.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_batch.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_batch.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_config.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_config.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_docker.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_docker.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_load.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_load.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_parser.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_parser.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_rest_slicer_cli.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_rest_slicer_cli.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/test_web_client.py` & `girder-slicer-cli-web-1.3.3.dev2/tests/test_web_client.py`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/configViewSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/configViewSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/containerViewSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/containerViewSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/dockerTaskSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/dockerTaskSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/itemSelectorWidgetSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/itemSelectorWidgetSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/panelGroupSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/panelGroupSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/parseSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/parseSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tests/web_client_specs/widgetSpec.js` & `girder-slicer-cli-web-1.3.3.dev2/tests/web_client_specs/widgetSpec.js`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/tox.ini` & `girder-slicer-cli-web-1.3.3.dev2/tox.ini`

 * *Files identical despite different names*

### Comparing `girder-slicer-cli-web-1.3.2.dev6/utils/xmltojson.py` & `girder-slicer-cli-web-1.3.3.dev2/utils/xmltojson.py`
